...
const MainLayout = ({ vehicles }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f7fafc]">
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:block fixed left-0 top-[67px] h-[calc(100vh-67px)] w-64">
        <SideNav 
      ...
      {/* Desktop Past Results Drawer */}
      <div className={`
        hidden md:block fixed left-64 top-[67px] h-[calc(100vh-67px)]
